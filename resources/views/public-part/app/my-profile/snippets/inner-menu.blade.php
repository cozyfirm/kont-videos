    ...
    <div class="mobile_small_menu">
        ...
        <a href="#">
            <div class="single_elem @if(Route::is('dashboard.chat')) active @endif">
                ...
                <div class="total_no" id="number-of-unread-messages-m"><p>6</p></div>
            </div>
        </a>
        <a href="#">
        ...
        <div class="inner__menu_profile">
            <a href="{{ route('public.my-profile') }}">
                <div class="inner__menu_profile_img_w">
                    ...
                    @else
                        <img class="silhouette" src="{{ asset('files/images/public-part/users/silhouette.png') }}" alt="">
                    @endif
                </div>
                <p> {{ Auth()->user()->name }} </p>
            </a>
        ...
        <div class="inner__menu_links">
            ...
            <a href="#">
                <div class="inner__menu_links_link @if(Route::is('dashboard.latest-news') or Route::is('dashboard.latest-new')) active @endif">
                    <img class="silhouette" src="{{ asset('files/images/public-part/users/note.svg') }}" alt="">
                    <p>{{ __('Zabilješke') }}</p>
                </div>
            </a>
        </div>
